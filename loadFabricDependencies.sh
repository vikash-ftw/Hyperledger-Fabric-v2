...
# We will download only Fabric Binaries (Fabric v2.5.9 and Fabric CA v1.5.12) and skip Docker Images & Sample Repo
curl -sSL https://raw.githubusercontent.com/hyperledger/fabric/master/scripts/bootstrap.sh | bash -s -- 2.5.9 1.5.12 -d -s
