...
function createOrg1() {
  ...
  ## Other Org user and admin MSP related crypto
...
# OrdererOrg having 2 orderer setup
function createOrderer() {
  ...
  ## Registering orderer2 (2nd Orderer)
  ...
  ## Other OrdererOrg admin MSP related crypto
